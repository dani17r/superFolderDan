  ...
  <q-page class="row items-center justify-evenly">
    ...
    <ContentFiles>
      <div class="text-center">
        <q-icon name="note_add" :size="'80px'" color="primary" class="tw-opacity-50 tw-cursor-pointer"
          @click="searchFile()" />
        <p class="text-accent tw-cursor-pointer" @click="searchFile()">New File</p>
        <input type="file" id="file-input" name="file" @change="uploadFile" style="display: none;"
          accept=".doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,text/plain,.pdf,.jpg,.jpeg,.png" required>
      </div>
