  ...
  <q-page class="flex flex-center">
    <q-card class="box-card-content">
      ...
      <form @submit.prevent.stop="onSubmit" @reset.prevent.stop="onReset">
        ...
        <q-card-section>
          <q-input dense outlined v-model="form.email.val.value" label="E-mail"
            :ref="(val) => (form.email.refs.value = val)" :rules="form.email.rules"></q-input>
        ...
        <q-card-section>
          <q-btn unelevated color="primary" label="Accept" no-caps class="full-width tw-rounded-lg no-shadow"
            type="submit" />

          <q-btn flat color="primary" label="Reset" no-caps class="full-width tw-rounded-lg no-shadow tw-mt-3"
            type="reset" />
        </q-card-section>
        ...
        <q-card-section class="text-center q-pt-none">
          <div class="text-grey-8">
            ...
            <router-Link tag="a" :to="{ name: 'register' }"
              class="tw-inline-flex tw-mt-2 text-secondary text-weight-bold">here.</router-Link>
          </div>
        </q-card-section>
